...
<html lang="en">
    <head>
        ...
        @stack('style-alt')
        <title>Wanderlust tourplanner </title>
    </head>
    <body>
        <!--==================== HEADER ====================-->
        <header class="header" id="header">
            <nav class="nav container">
                <a href="{{ route('homepage') }}" class="nav__logo" style="font-size: 17px"
                    > WANDERLUST <i class="bx bxs-map"></i> TOUR </a
                >

                <div class="nav__menu" style="font-size: 13px">
                    <ul class="nav__list">
                        <li class="nav__item">
                            <a href="{{ route('homepage') }}" class="nav__link {{ request()->is('/') ? ' active-link' : '' }}">
                                <i class="bx bx-home-alt"></i>
                                <span style="min-width:fit-content">Home</span>
                            </a>
                        </li>
                        <li class="nav__item">
                            <a href="{{ route('travel_package.index') }}" class="nav__link {{ request()->is('travel-packages') || request()->is('travel-packages/*')  ? ' active-link' : '' }}">
                                ...
                                <span style="min-width:fit-content">Tour Pakages </span>
                            </a>
                        </li>
                        ...
                        <li class="nav__item">
                            <a href="{{ route('travel_package.index') }}" class="nav__link {{ request()->is('travel-packages') || request()->is('travel-packages/*')  ? ' active-link' : '' }}">
                                <i class="bx bx-building-house"></i>
                                <span style="min-width:fit-content"> Destination </span>
                            </a>
                        </li>
                        ...
                        <li class="nav__item">
                            <a href="{{ route('contact') }}" class="nav__link {{ request()->is('contact') ? ' active-link' : '' }}">
                                ...
                                <span style="min-width:fit-content">Contact us</span>
                            </a>
                        </li>
